...
void optional_header(FILE*, word*, dword*, dword*);
void optional_header_data_directories(FILE*, dword, dword*, dword*);
void section_table(FILE*, word, dword*, dword*, dword*);
void optional_header_data_directories_item(FILE*, word, dword, dword*, dword*, dword, word, dword*, dword*, dword*);
void export_table(FILE*);
void import_table(FILE*, dword, word, dword*, dword*, dword*, word);
...
void tls_table(FILE*);
void load_config_table(FILE*, word);
void bound_import(FILE*);
void iat(FILE*);
void delay_import_descriptor(FILE*);
void clr_runtime_header(FILE*);
void reserved(FILE*);
void thunk_data(FILE*, dword);
void resource_directory_entry(FILE*, dword);
